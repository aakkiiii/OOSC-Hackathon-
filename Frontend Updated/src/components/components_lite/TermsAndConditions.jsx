      ...
      <div className="max-w-4xl mx-auto px-4 py-12 md:px-8">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              By accessing and using this Scholarship Portal, you accept and
          ...
          <section>
            ...
            <p>
              ...
              person, transmitting obscene or offensive content.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Recruiters must post accurate, non-discriminatory
              job listings. You agree not to post false or misleading
              information about the job, company, or salary. We reserve the
              right to remove any postings that violate these terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Your privacy is extremely important to us. By using this service,
              you consent to the collection, processing, and storage of your
              personal information (including resumes and profile data) as
